...
$implementation_date_start = date('Y-m-d H:i:s',strtotime($vaccination->implementation_date.' '.$vaccination->schedule->implementation_time_start));
$implementation_date_end = date('Y-m-d H:i:s',strtotime($vaccination->implementation_date.' '.$vaccination->schedule->implementation_time_end));
