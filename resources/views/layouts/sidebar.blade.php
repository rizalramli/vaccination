<ul class="nav nav-aside">
    ...
    <li class="nav-item"><a href="{{ route('employee-vaccination.index') }}" class="nav-link {{ (request()->is('employee-vaccination') || request()->is('employee-vaccination/*')) ? 'active' : '' }}"><i data-feather="calendar"></i> <span>Jadwal vaksinasi</span></a></li>
